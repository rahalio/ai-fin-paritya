 ...
 * Usage: TABLE_NAME=paritya-core-local AWS_ENDPOINT_URL=http://localhost:8000 node scripts/ensure-dynamo-table.mjs
 */
...
async function main() {
  process.env.TABLE_NAME =
    process.env.TABLE_NAME || 'paritya-core-local';

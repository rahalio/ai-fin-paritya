/**
 * Evidence Services - Application Layer Export
 *
...
/**
 * Evidence Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for evidence domain.
 */

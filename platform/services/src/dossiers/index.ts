/**
 * Dossiers Services - Application Layer Export
 *
...
/**
 * Dossiers Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for dossiers domain.
 */

...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/appeals\//, domain: "appeals" },
  { pattern: /\/cases\//, domain: "cases" },
  { pattern: /\/dossiers\//, domain: "dossiers" },
  ...
  { pattern: /\/playbooks\//, domain: "playbooks" },
  { pattern: /\/usecases\//, domain: "usecases" },
];
...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "appeals":
        domainDeps = buildAppealsDomainModule(dynamoClient);
        break;
      case "cases":
        domainDeps = buildCasesDomainModule(dynamoClient);
        break;
      case "dossiers":
        domainDeps = buildDossiersDomainModule(dynamoClient);
        break;
      case "evidence":
      ...
      case "monitoring":
        ...
        break;
      case "playbooks":
        domainDeps = buildPlaybooksDomainModule(dynamoClient);
        break;
      case "usecases":
 ...
 */
export function getAppealsDeps(
  request: FastifyRequest,
): DomainDependencies["appeals"] {
  return getDomainDeps(request, "appeals");
}
...
export function getDossiersDeps(
  request: FastifyRequest,
): DomainDependencies["dossiers"] {
  return getDomainDeps(request, "dossiers");
}
...
export function getPlaybooksDeps(
  request: FastifyRequest,
): DomainDependencies["playbooks"] {
  return getDomainDeps(request, "playbooks");
}
